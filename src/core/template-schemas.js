...
export const projectTemplateSchema = [
  ...
  { key: "health", label: "健康度", required: true, type: "health", example: "R", values: healthValues },
  { key: "complexity", label: "复杂度", required: true, type: "number", example: "5" },
  { key: "status", label: "项目状态", required: true, type: "string", example: "UAT" },
  { key: "pm", label: "当前PM", required: true, type: "string", example: "陈安" },
...
export const milestoneTemplateSchema = [
  ...
  { key: "plannedStart", label: "计划开始日期", required: true, type: "date", example: "2026-01-05" },
  { key: "plannedEnd", label: "计划结束日期", required: true, type: "date", example: "2026-01-26" },
  { key: "state", label: "状态", required: true, type: "health", example: "G", values: healthValues },
  { key: "actualStart", label: "实际开始日期", required: false, type: "date", example: "2026-01-08" },
  { key: "actualEnd", label: "实际结束日期", required: false, type: "date", example: "2026-01-24" },
